...
export declare function getCacheOptions(appConfig: AppConfig): CacheOptions;
export declare function getTensorCacheAccessOptions(scope: CacheScope, appConfig: AppConfig): tvmjs.TensorCacheAccessOptions;
 ...
 * @returns
 */
export declare function asyncLoadTokenizer(baseUrl: string, config: ChatConfig, appConfig: AppConfig, logger?: (msg: string) => void, integrity?: ModelIntegrity): Promise<Tokenizer>;
export {};
